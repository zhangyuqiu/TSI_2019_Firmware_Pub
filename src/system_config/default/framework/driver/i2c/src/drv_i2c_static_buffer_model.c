...
void DRV_I2C0_Initialize(void)
{
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C4_MASTER, INT_PRIORITY_LEVEL2);
    ...
    PLIB_INT_VectorPrioritySet(INT_ID_0, INT_VECTOR_I2C4_BUS, INT_PRIORITY_LEVEL2);
